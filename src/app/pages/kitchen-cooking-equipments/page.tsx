...
function page() {
  ...
  return (
    ...
    <p>KITCHEN COOKING EQUIPMENTS</p>
    </div>

    <div className='flex flex-col gap-3 items-center'>
    <h2 className='text-3xl lg:text-5xl font-bold leading-normal text-center'>
    Premium <span className='special-text'>Cooking Equipment <br /></span> Collection
    </h2>
    <p className='text-center para-content text-gray-700 w-full lg:w-[700px]'>Our Our premium cooking equipment collection is designed to meet the demands of modern commercial kitchens. From high-performance cooking ranges and grills to fryers, ovens, and specialized cooking solutions, every product is crafted for durability, efficiency, and consistent performance, helping chefs deliver exceptional results every day.</p>
    </div>

    <div className='grid grid-cols-1 lg:grid-cols-4 gap-8 mt-5'>
    {
        kitchenCookingEquipmentArray.map((x,y)=>{
            return(
