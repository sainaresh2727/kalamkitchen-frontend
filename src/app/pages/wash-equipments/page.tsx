...
function page() {
  ...
  return (
    ...
    <p>WASHING EQUIPMENTS</p>
    </div>

    <div className='flex flex-col gap-3 items-center'>
  <h2 className='text-3xl lg:text-5xl font-bold leading-normal text-center'>
    Ensure Hygiene and Efficiency with <span className='special-text'>Advanced Washing <br /> Equipment</span>
  </h2>

  <p className='text-center para-content text-gray-700 w-full lg:w-[700px]'>
    Our Washing Equipment is designed to deliver powerful and efficient cleaning solutions for commercial kitchens. Built with high-quality stainless steel and advanced washing technology, it ensures thorough cleaning of utensils, cookware, and kitchen tools while maintaining strict hygiene standards. Engineered for durability, water efficiency, and ease of operation, it is ideal for restaurants, hotels, catering units, hospitals, and institutional kitchens where cleanliness and speed are essential.
  </p>
    </div>

    <div className='grid grid-cols-1 lg:grid-cols-4 gap-8 mt-5'>
    {
        washEquipments.map((x,y)=>{
            return(
