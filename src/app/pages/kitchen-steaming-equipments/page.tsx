...
function page() {
  ...
  <h2 className='text-3xl lg:text-5xl font-bold leading-normal text-center'>
    Advanced & Efficient <span className='special-text'>Steam Cooking <br /> Equipment</span> Solutions
  </h2>

  <p className='text-center para-content text-gray-700 w-full lg:w-[700px]'>
    Our Steam Cooking Equipment is designed to deliver fast, energy-efficient, and hygienic cooking for commercial kitchens. From steam boilers and idli steamers to rice steamers and bulk cooking units, every product is manufactured with premium stainless steel to ensure superior performance, even heat distribution, and long-lasting durability for hotels, restaurants, canteens, cloud kitchens, and catering businesses.
  </p>
</div>

    <div className='grid grid-cols-1 lg:grid-cols-4 gap-8 mt-5'>
    {
        steamCookingEquipmentArray.map((x,y)=>{
            return(
