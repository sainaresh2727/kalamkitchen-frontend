...
function page() {
  ...
  return (
    ...
    <p>BAKING EQUIPMENTS</p>
    </div>

    <div className='flex flex-col gap-3 items-center'>
  <h2 className='text-3xl lg:text-5xl font-bold leading-normal text-center'>
    Professional <span className='special-text'>Baking Equipment <br /> Solutions</span>
  </h2>

  <p className='text-center para-content text-gray-700 w-full lg:w-[800px]'>
    Our Baking Equipment is designed to support efficient mixing, baking, proofing, and food preparation for commercial bakeries and food businesses. Built for durability and consistent performance, our solutions help improve productivity while maintaining superior baking quality. Manufactured using premium stainless steel and advanced technology, our equipment is ideal for bakeries, cafés, hotels, restaurants, pastry shops, cloud kitchens, and large-scale food production facilities.
  </p>
</div>

    <div className='grid grid-cols-1 lg:grid-cols-4 gap-8 mt-5'>
    {
        bakeryEquipments.map((x,y)=>{
            return(
