...
function page() {
  ...
  <h2 className='text-3xl lg:text-5xl font-bold leading-normal text-center'>
    Streamline Kitchen Operations with <span className='special-text'>Premium Kitchen <br /> Trolleys</span>
  </h2>

  <p className='text-center para-content text-gray-700 w-full lg:w-[700px]'>
    Our Kitchen Trolleys are designed to simplify transportation, organization, and workflow in busy commercial kitchens. Built from premium stainless steel for superior strength and durability, they provide smooth mobility, high load capacity, and long-lasting performance. Ideal for restaurants, hotels, catering services, hospitals, and institutional kitchens, these trolleys help move ingredients, cookware, and prepared meals efficiently while maintaining hygiene and maximizing productivity.
  </p>
    </div>

    <div className='grid grid-cols-1 lg:grid-cols-4 gap-8 mt-5'>
    {
        kitchenTrolleys.map((x,y)=>{
            return(
