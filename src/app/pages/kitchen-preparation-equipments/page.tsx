...
function page() {
  ...
  return (
    ...
    <p>KITCHEN PREPARATION EQUIPMENTS</p>
    </div>

    <div className='flex flex-col gap-3 items-center'>
    <h2 className='text-3xl lg:text-5xl font-bold leading-normal text-center'>
    Smart & Durable <span className='special-text'>Kitchen Preparation <br /> Equipment</span> Excellence
    </h2>
    <p className='text-center para-content text-gray-700 w-full lg:w-[700px]'>Our Our Kitchen Preparation Equipment is engineered to simplify food preparation while maximizing productivity in commercial kitchens. From work tables and cutting stations to preparation counters and utility units, every product is crafted using premium stainless steel to ensure durability, hygiene, and long-lasting performance for restaurants, hotels, cloud kitchens, and catering businesses.</p>
    </div>

    <div className='grid grid-cols-1 lg:grid-cols-4 gap-8 mt-5'>
    {
        kitchenPreparationEquipmentArray.map((x,y)=>{
            return(
