...
function page() {
  ...
  return (
    ...
    <p>KITCHEN STEAMING EQUIPMENTS</p>
    </div>

    <div className='flex flex-col gap-3 items-center'>
  <h2 className='text-3xl lg:text-5xl font-bold leading-normal text-center'>
    Smart Automation for <span className='special-text'>Modern Kitchen Machines <br /> Equipment</span>
  </h2>

  <p className='text-center para-content text-gray-700 w-full lg:w-[700px]'>
    Our Kitchen Machines Equipment brings speed, consistency, and precision to commercial food preparation. Designed for high-performance operations, these machines handle mixing, grinding, slicing, and processing with ease. Built using robust stainless steel and advanced engineering, they help streamline workflow, reduce manual effort, and improve overall kitchen productivity in restaurants, hotels, bakeries, and large-scale catering units.
  </p>
    </div>

    <div className='grid grid-cols-1 lg:grid-cols-4 gap-8 mt-5'>
    {
        kitchenMachinesArray.map((x,y)=>{
            return(
