...
function page() {
  ...
  return (
    ...
    <p>KITCHEN STORAGE EQUIPMENTS</p>
    </div>

    <div className='flex flex-col gap-3 items-center'>
    <h2 className='text-3xl lg:text-5xl font-bold leading-normal text-center'>
    Smart & Durable <span className='special-text'>Kitchen Storage <br /> Equipment</span> Solutions
    </h2>
    <p className='text-center para-content text-gray-700 w-full lg:w-[700px]'>Our Kitchen Storage Equipment range is designed to maximize space efficiency, hygiene, and organization in commercial and industrial kitchens. Built with high-quality, food-grade materials, each unit ensures long-lasting durability, easy maintenance, and optimal workflow</p>
    </div>

    <div className='grid grid-cols-1 lg:grid-cols-4 gap-8 mt-5'>
    {
        kitchenStorageEquipmentArray.map((x,y)=>{
            return(
