...
function page() {
  ...
  return (
    ...
    <p>REFRIGENATOR EQUIPMENTS</p>
    </div>

    <div className='flex flex-col gap-3 items-center'>
    <h2 className='text-3xl lg:text-5xl font-bold leading-normal text-center'>
        Keep Every Ingredient Fresh with <span className='special-text'>Premium   Refrigeration <br /> Equipment</span>
    </h2>

  <p className='text-center para-content text-gray-700 w-full lg:w-[700px]'>
  Our Refrigeration Equipment is designed to preserve freshness, maintain food safety, and deliver reliable cooling performance for commercial kitchens. Engineered for efficiency and durability, our refrigeration solutions provide precise temperature control for storing ingredients, beverages, and prepared food. Crafted from premium stainless steel with advanced cooling technology, they optimize energy efficiency, maximize storage capacity, and ensure long-lasting performance for restaurants, hotels, bakeries, supermarkets, and large-scale catering facilities.
