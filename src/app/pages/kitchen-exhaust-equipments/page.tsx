...
function page() {
  ...
  return (
    ...
    <p>KITCHEN EXHAUST EQUIPMENTS</p>
    </div>

    <div className='flex flex-col gap-3 items-center'>
  <h2 className='text-3xl lg:text-5xl font-bold leading-normal text-center'>
    Powerful Ventilation for <span className='special-text'>Modern Kitchen <br /> Exhaust Systems</span>
  </h2>

  <p className='text-center para-content text-gray-700 w-full lg:w-[700px]'>
    Our Kitchen Exhaust Equipment is designed to maintain a clean, safe, and comfortable cooking environment in commercial kitchens. Engineered for high-efficiency airflow and smoke removal, it effectively eliminates heat, grease, odors, and airborne particles. Built with durable stainless steel and advanced filtration systems, it ensures long-lasting performance and improved hygiene for restaurants, hotels, canteens, bakeries, and large-scale food production units.
  </p>
</div>

    <div className='grid grid-cols-1 lg:grid-cols-4 gap-8 mt-5'>
    {
        exhaustArray.map((x,y)=>{
            return(
